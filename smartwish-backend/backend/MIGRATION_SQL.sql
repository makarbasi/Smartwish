-- Migration: Update saved_designs table to be compatible with sw_templates
-- This allows users to copy from sw_templates, edit, and publish back

-- Add new columns to match sw_templates structure
...
-- Update existing records to set created_by_user_id to user_id
UPDATE saved_designs 
SET created_by_user_id = user_id 
WHERE created_by_user_id IS NULL;

-- Add check constraint for status to include new states
ALTER TABLE saved_designs 
...
-- Create a function to copy from sw_templates to saved_designs
...
-- Create a function to publish saved_design back to sw_templates
...
-- Update RLS policies to handle new relationships
...
-- Create updated view for published designs
