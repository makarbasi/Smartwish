...
export default function SignUp() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      const url = DynamicRouter('auth', 'signup')
      ...
      console.log('Post-signup sign in result:', result)

      if (result?.error) {
        console.error('Post-signup sign in error:', result.error)
        setError('Registration successful, but login failed. Please try signing in.')
      } else if (result?.ok) {
        console.log('Post-signup sign in successful, redirecting to dashboard')
    ...
    <>
      <div className="flex min-h-full flex-col justify-center py-12 sm:px-6 lg:px-8">
        <div className="sm:mx-auto sm:w-full sm:max-w-md">
          <img alt="SmartWish" src="https://tailwindcss.com/plus-assets/img/logos/mark.svg?color=indigo&shade=600" className="mx-auto h-10 w-auto" />
