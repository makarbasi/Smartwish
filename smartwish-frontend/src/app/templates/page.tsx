          ...
          <section>
            ...
            {isKiosk && featuredCategories.length > 0 && !showCarouselsView && (
              <button
                ...
                className="group mb-8 inline-flex items-center gap-3 px-5 py-3 rounded-xl bg-gradient-to-r from-indigo-50 via-white to-purple-50 border border-indigo-200 shadow-sm hover:shadow-md hover:border-indigo-300 transition-all duration-300"
              >
                <div className="w-8 h-8 rounded-lg bg-gradient-to-br from-indigo-500 to-purple-500 flex items-center justify-center shadow-md group-hover:shadow-lg transition-shadow">
