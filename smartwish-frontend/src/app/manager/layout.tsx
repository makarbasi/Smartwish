...
const navigation = [
  ...
  { name: "Gift Cards", href: "/manager/gift-cards", icon: CreditCardIcon },
  { name: "My Kiosks", href: "/manager/kiosks", icon: ComputerDesktopIcon },
  { name: "Print Logs", href: "/manager/print-logs", icon: DocumentTextIcon },
  { name: "Earnings", href: "/manager/earnings", icon: CurrencyDollarIcon },
];
                    ...
                    <ul role="list" className="flex flex-1 flex-col gap-y-7">
                      ...
                      <li className="mt-auto">
                        <button
                          ...
                          className="group -mx-2 flex w-full gap-x-3 rounded-md p-2 text-sm font-semibold leading-6 text-teal-100 hover:bg-teal-700 hover:text-white"
                        >
                          <ArrowRightOnRectangleIcon
            ...
            <ul role="list" className="flex flex-1 flex-col gap-y-7">
              ...
              <li className="mt-auto">
                <div className="border-t border-teal-500 pt-4">
                  <div className="flex items-center gap-x-3 px-2 py-2 text-sm text-teal-200">
                  ...
                  <button
                    onClick={handleSignOut}
                    className="group mt-2 -mx-2 flex w-full gap-x-3 rounded-md p-2 text-sm font-semibold leading-6 text-teal-100 hover:bg-teal-700 hover:text-white"
                  >
                    <ArrowRightOnRectangleIcon
                      className="h-6 w-6 shrink-0 text-teal-200 group-hover:text-white"
                      aria-hidden="true"
        ...
        <div className="sticky top-0 z-40 flex h-16 shrink-0 items-center gap-x-4 border-b border-gray-200 bg-white px-4 shadow-sm sm:gap-x-6 sm:px-6 lg:px-8 lg:hidden">
          ...
          <div className="flex flex-1 items-center justify-end gap-x-4 lg:gap-x-6">
            <div className="flex items-center gap-x-2">
              <BuildingStorefrontIcon className="h-6 w-6 text-teal-600" />
