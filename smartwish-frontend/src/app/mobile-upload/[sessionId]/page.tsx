      ...
      <div className="flex-1 flex items-center justify-center py-6">
        {previewUrl ? (
          <div className="relative">
            ...
            <button
              onClick={handleClear}
              className="absolute -top-2 -right-2 w-10 h-10 bg-red-500 text-white rounded-full shadow-lg flex items-center justify-center active:scale-90 transition-transform"
            >
