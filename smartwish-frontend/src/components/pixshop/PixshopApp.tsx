...
const PixshopApp: React.FC = () => {
  ...
  return (
    <div className="min-h-screen bg-[#fafafa] relative overflow-hidden pb-32">
      ...
      {/* Bottom Tab Navigation - Positioned at bottom of content */}
      ...
      {/* Text Input and Generate Button - Positioned above navigation */}
      {activeTab === 'retouch' && (
