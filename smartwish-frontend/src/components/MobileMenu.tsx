...
export default function MobileMenu() {
    ...
    return (
        <div className="md:hidden">
            ...
            <div className={`fixed top-0 left-0 right-0 z-40 bg-white border-b border-gray-200 shadow-sm transition-all duration-300 ease-in-out ${
                    ...
                    <div className="flex flex-col h-full">
                        ...
                        <div className="p-4 border-b border-gray-200">
                            <div className="flex items-center gap-3">
                                <Image src="https://i.pravatar.cc/80?img=12" alt="" width={48} height={48} className="w-12 h-12 rounded-full ring-1 ring-gray-200" />
                                <div>
